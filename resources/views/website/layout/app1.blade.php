...
<html lang="en">
<head>
<title>BPKH Wilayah III Pontaiank</title>
		...
		<div class="banner-agileinfo">
			<div class="container">		
				...
				<div class="banner-w3text">
					<h4><b>Balai Pemantapan Kawasan Hutan</b></h4>
					<h2>Wilayah III Pontianak</h2>
					<h5>Direktorat Jenderal Planologi Kehutanan dan Tata Lingkungan</h5>								
				</div> 
			</div>
			<!-- //banner-info --> 
		</div>

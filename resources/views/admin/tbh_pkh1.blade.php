    ...
    Tambah Data Tabel 1
      <small>BPKH Wilayah III Pontianak</small>
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="/admin/pkh">PKH</a></li>
            <li class="nonactive"><a href="/admin/pkh/create">Tambah</a></li>
          </ol>
</section>
    ...
    <div class="form-group">
        <div class="box box-success">
              <div class="box-header with-border">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('admin.a-pkh.store') }}">
                  ...
                  {{ method_field('POST') }}
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        <label class="col-md-3 control-label" for="nama_pkh">Kawasan Hutan</label>

                        <div class="col-md-7">
                          <input type="text" class="form-control" id="nama_pkh" placeholder="Kawasan Hutan" name="nama_pkh" >
                        </div>
                      </div>
                      <div class="form-group">

  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box box-success">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <a type="button" class="btn bg-navy margin" href="/admin/isdh3/create"><td>Tambah</a>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <th colspan="" rowspan="" headers="" scope="1">a</th>
                  <th colspan="" rowspan="" headers="" scope="1">s</th>
                  <th colspan="" rowspan="" headers="" scope="1">d</th>
                  <th colspan="" rowspan="" headers="" scope="1">g</th>
                  <th colspan="" rowspan="" headers="" scope="1">h</th>
                  <th colspan="" rowspan="" headers="" scope="1">k</th>
                </tr>
                </thead>
                <tbody>
                <tr>
